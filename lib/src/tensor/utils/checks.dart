...
/// Adjusts and checks an [end] index to be larger than start and smaller or
/// equal than [length], otherwise throw a [RangeError].
...
/// Checks if [step] value is positive or zero, otherwise throw a [RangeError].
int checkStep(int step, [String? name, String? message]) {
  if (step > 0) {
    return step;
  }
  throw RangeError.range(step, 0, null, name, message);
}
