...
export 'view/convolution_matrix.dart'
    show MatrixConvolution, ConvolutionMatrixExtension;
...
export 'view/flipped_vertical_matrix.dart' show FlippedVerticalMatrixExtension;
export 'view/index_matrix.dart' show IndexMatrixExtension;
export 'view/matrix_matrix_multiplication_matrix.dart'
    show MatrixMatrixMultiplicationMatrixExtension;
export 'view/matrix_vector_multiplication_vector.dart'
    show MatrixVectorMultiplicationVectorExtension;
...
export 'view/unary_operation_matrix.dart' show UnaryOperationMatrixExtension;
export 'view/unmodifiable_matrix.dart' show UnmodifiableMatrixExtension;
