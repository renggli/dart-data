...
/// Assert a number of properties on x- and y-coordinate data.
///
...
void validateCoordinates<T>(
  ...
  assert(() {
    if (xs.count != ys.count) {
      throw ArgumentError('The x- and y-coordinates must have the same number '
