...
Vector<double> linearSpaced(double start, double stop,
    {int count = 10,
...
/// Generates a vector with a sequence of [count] evenly spaced values on a log
/// scale (a geometric progression) on the interval between `base ^ start` and
/// `base ^ stop`.
Vector<double> logarithmicSpaced(double start, double stop,
    {int count = 10,
    double base = 10.0,
    bool includeEndpoint = true,
    DataType<double>? dataType,
...
/// Generates a vector with a sequence of [count] evenly spaced values on a log
/// scale (a geometric progression) on the interval between [start] and [stop].
Vector<double> geometricSpaced(double start, double stop,
        {int count = 10,
        bool includeEndpoint = true,
        DataType<double>? dataType,
        VectorFormat? format}) =>
