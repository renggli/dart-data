...
void main() {
  group('layout', () {
    ...
    test('3x2 with offset', () {
      final layout = Layout(shape: [3, 2], offset: 7);
      expect(
          layout,
          isLayout(
              rank: 2,
